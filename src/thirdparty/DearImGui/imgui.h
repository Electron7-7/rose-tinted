...
namespace ImGui
{
    ...
    IMGUI_API bool          DragGLMv2(const char* label, glm::vec2* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // If v_min >= v_max we have no bound
    IMGUI_API bool          DragGLMv3(const char* label, glm::vec3* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // If v_min >= v_max we have no bound
    IMGUI_API bool          DragGLMquat(const char* label, glm::quat* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // If v_min >= v_max we have no bound
    ...
    IMGUI_API bool          DragInt2(const char* label, int* v, int* v2, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          DragInt3(const char* label, int* v, int* v2, int* v3, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          DragInt4(const char* label, int* v, int* v2, int* v3, int* v4, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d", ImGuiSliderFlags flags = 0);
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/imgui/issues/3361
    IMGUI_API bool          SliderGLMv2(const char* label, glm::vec2* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    IMGUI_API bool          SliderGLMv3(const char* label, glm::vec3* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    IMGUI_API bool          SliderGLMquat(const char* label, glm::quat* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    ...
    IMGUI_API bool          InputGLMv2(const char* label, glm::vec2* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputGLMv3(const char* label, glm::vec3* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API bool          InputInt2(const char* label, int* v, int* v2, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt3(const char* label, int* v, int* v2, int* v3, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt4(const char* label, int* v, int* v2, int* v3, int* v4, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt(const char* label, unsigned int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt2(const char* label, unsigned int v[2], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt3(const char* label, unsigned int v[3], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt4(const char* label, unsigned int v[4], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt2(const char* label, unsigned int* v, unsigned int* v2, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt3(const char* label, unsigned int* v, unsigned int* v2, unsigned int* v3, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputUInt4(const char* label, unsigned int* v, unsigned int* v2, unsigned int* v3, unsigned int* v4, ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API bool          ColorEditGLMv3(const char* label, glm::vec3* col, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEditGLMv4(const char* label, glm::vec4* col, ImGuiColorEditFlags flags = 0);
